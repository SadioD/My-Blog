...
class ImageThumb
{
	// Permet de créer une image miniature -----------------------------------------------------------------------------------------------------------------------
	public function createThumb( $image_src , $image_dest = NULL , $max_size = 100, $expand = FALSE, $square = FALSE )
		{
			// Permet de créer des images miniatures (photo avatar)
